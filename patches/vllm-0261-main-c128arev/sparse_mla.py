...
class DeepseekV4FlashMLAMetadataBuilder(
    ...
    def _build_c128a_metadata(
        ...
        # LANE c128arev (upstream edd4c8176c / PR #51318, reverts #50004): the adaptive
        # packed top-k width made this eager metadata builder write batch-dependent row
        # widths while the graph-captured decode consumer keeps its capture-time stride —
        # rows >=1 read stale offsets (upstream issue #52448 reasoning-loop runaways).
