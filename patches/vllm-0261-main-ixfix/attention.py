    ...
    def forward(
        ...
        if isinstance(attn_metadata, dict):
            ...
            if (
                ...
                # LANE ixfix (upstream 292187dd8c / PR #52492): the short-context
                # shortcut must not run during breakable-graph capture — capture uses
                # short dummy metadata, so an unguarded shortcut gets baked into the
                # graph and replay attends only to the first ~2K of any >2K prefix.
