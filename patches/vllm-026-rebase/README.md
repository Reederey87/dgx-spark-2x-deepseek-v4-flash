...
@944,471 tokens · battery acceptance 0.784. One known cost: the KV pool re-baselined
2,948,751 → **2,075,155 tokens** at the unchanged 19.85 GiB byte-pin (0.26's per-token
layout costs +42%) — single 1M-context requests are unaffected; concurrent-long-context
headroom is thinner. Full record in `docs/10-vllm-026-rebase.md`.
