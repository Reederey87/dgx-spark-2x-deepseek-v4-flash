...
run_prompt python30 "Write a 30-line Python function that validates and normalizes a list of host records." nonempty 8192 >> "$results" || fail "python request failed" "inspect API logs"
